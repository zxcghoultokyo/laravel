...
Твоє завдання: згенерувати ОДНЕ природне уточнююче питання (до 20 слів).

Питай про те, що дійсно допоможе вибрати товар з цього списку:
- розмір, колір, бюджет, характеристики, призначення
- ТІЛЬКИ якщо є різноманітність у знайдених товарах
