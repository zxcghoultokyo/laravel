...
ПОШУК:
- Перефразовуй запит у назви товарів: "щоб мамі дзвонити" → шукай "телефон смартфон"
- "зафіксувати волосся" → шукай "лак для волосся hair spray"
- "подарунок дівчині/мамі/другу" → запитай ЩО подарувати (косметика? одяг? техніка?) або запропонуй популярне
