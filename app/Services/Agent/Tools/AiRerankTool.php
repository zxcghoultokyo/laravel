...
class AiRerankTool
{
    ...
    private function buildRerankPrompt(array $candidates, string $query, array $filters): string
    {
        ...
        return <<<PROMPT
Ти — AI асистент для підбору тактичного спорядження.
...
2. Враховуй: відповідність запиту, ціна/якість, популярність, наявність
3. Поверни JSON:

{
  "chosen_ids": [123, 456, 789, ...],
  "reasoning": {
    "123": "Найпопулярніша модель, ідеальна ціна",
