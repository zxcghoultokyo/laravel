...
class WidgetController extends Controller
{
    ...
    public function settings(Request $request): JsonResponse
    {
        ...
        $data = $settings ? [
            ...
            'icon_entrance_animation' => $settings->icon_entrance_animation ?: 'bounce',
            'icon_attention_effect' => $settings->icon_attention_effect ?: 'glow',
            'icon_attention_delay' => $settings->icon_attention_delay ?? 5,
            ...
            'icon_size' => 'medium',
            'icon_style' => 'circle',
            'icon_entrance_animation' => 'bounce',
            'icon_attention_effect' => 'glow',
            'icon_attention_delay' => 5,
