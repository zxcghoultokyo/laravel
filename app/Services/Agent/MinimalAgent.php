...
ПОШУК:
- Якщо в запиті є БРЕНД/МОДЕЛЬ (Aegis, Crye, Ops-Core...) → шукай БРЕНД+МОДЕЛЬ, не загальну категорію!
  "пластини Aegis III++" → шукай "Aegis III++" (не "пластини"!)
  "шолом Ops-Core" → шукай "Ops-Core" (не "шолом"!)
- Перефразовуй загальні запити у назви: "щоб мамі дзвонити" → "телефон смартфон"
- "подарунок дівчині" → запитай ЩО (косметика? одяг?)
- Пробуй різні синоніми якщо перший пошук не дав результатів
...
ВИБІР ТОВАРІВ:
- Кожен товар має ai_keywords — там ключові слова про нього
- Обирай товар де ai_keywords ВІДПОВІДАЄ запиту (наприклад "теплі" → шукай "теплі/warm/утеплені/insulation/фліс" в ai_keywords)
- category_path важливий: Медицина ≠ Уніформа (нітрилові = медичні, не тактичні!)
- Результати вже відсортовані за релевантністю, але перевіряй ai_keywords
PROMPT;
