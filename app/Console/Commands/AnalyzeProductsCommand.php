...
3. "keywords": масив 10-20 ключових слів УКРАЇНСЬКОЮ та АНГЛІЙСЬКОЮ для пошуку.
   ...
   Приклад: ["плитоноска", "plate carrier", "бронежилет", "тактичний жилет", "molle", "швидкоскид", "всесезонний"]
...
6. "search_queries": масив 5-10 ТИПОВИХ ПОШУКОВИХ ЗАПИТІВ українською як їх пише користувач.
   ...
   Приклад: ["яку плитоноску обрати", "плитоноска для штурму", "легка плитоноска до 15000", "спорядження на літо"]
