        ...
        <div class="container">
            ...
            <div class="version-block">
                ...
                <div class="version-header">
                    ...
                    <span class="version-date">25 березня 2026</span>
                </div>
                <ul class="change-list">
                    <li>
                        <span class="tag tag-new">✨ Нове</span>
                        <span>Автогенерація промпту з каталогу — для кожного магазину формується унікальний системний промпт на основі категорій, брендів та цінових діапазонів</span>
                    </li>
                    <li>
                        <span class="tag tag-new">✨ Нове</span>
                        <span>Сезонний пошук — чат розуміє запити «що купують навесні», «що взяти на літо», визначає мульти-сезони та додає сезонні теги до індексу</span>
                    </li>
                    <li>
                        <span class="tag tag-new">✨ Нове</span>
                        <span>Бета-опитування — форма для збору фідбеку від тестерів з NPS-шкалою, оцінкою проблем та відкритими коментарями</span>
                    </li>
                    <li>
                        <span class="tag tag-improved">⬆ Покращено</span>
                        <span>Розумний ретрай — якщо пошук за фразою нічого не знайшов, чат розбиває запит на окремі слова та шукає по кожному</span>
                    </li>
                    <li>
                        <span class="tag tag-improved">⬆ Покращено</span>
                        <span>Фільтрація за релевантністю — для запитів з 3+ слів перевіряє наявність ключових слів у назві товару, щоб не показувати зовсім нерелевантне</span>
                    </li>
                    <li>
                        <span class="tag tag-improved">⬆ Покращено</span>
                        <span>Вікова фільтрація для дитячих магазинів — чат автоматично підбирає товари за віковою категорією дитини (наприклад, «конструктор для 5 років»)</span>
                    </li>
                    <li>
                        <span class="tag tag-improved">⬆ Покращено</span>
                        <span>Рандомізація результатів — менше повторень одних і тих самих товарів у різних відповідях</span>
                    </li>
                    <li>
                        <span class="tag tag-fix">🐛 Фікс</span>
                        <span>Чат більше не генерує URL-посилання — всі товари відкриваються виключно через картки</span>
                    </li>
                    <li>
                        <span class="tag tag-fix">🐛 Фікс</span>
                        <span>Модерація емодзі — контрольоване використання замість надмірної кількості в кожній відповіді</span>
                    </li>
                    <li>
                        <span class="tag tag-admin">🎛 Адмін</span>
                        <span>Деталізація чат-сесій в аналітиці — можна переглядати окремі сесії та всі повідомлення в них</span>
                    </li>
                </ul>
            </div>
