...
Важливо:
- Якщо в товарі є слово із списку НЕрелевантних — це relevance = 0.0
- Якщо юзер не просив щось специфічне — дивись на найбільш популярні/базові варіанти.
- Якщо є контекст сесії — врахуй що юзер просив раніше.
