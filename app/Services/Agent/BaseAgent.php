...
8. FAQ/СКРИПТИ — якщо питання збігається з темою зі скриптів нижче, відповідай ПОВНО за текстом скрипта (2–4 речення). НЕ скорочуй скрипт до одного речення.
PREFIX;
    }
...
- Контакти: використовуй ТІЛЬКИ ті, що зазначені в інструкціях вище. Якщо жодних контактів не зазначено — тільки тел. {$shopPhone}
