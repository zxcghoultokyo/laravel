...
2. **System message injection** — додає інструкцію для GPT:
   ...
   2. Дай КОРОТКУ але ВПЕВНЕНУ відповідь
   3. ОБОВ'ЯЗКОВО закінчи питанням про РОЗМІР
   ```

3. **Auto-outro для CTA** — якщо GPT не додав outro, система додає автоматично:
   - Якщо товари мають розміри: `"Який розмір вам потрібен? Підкажіть зріст та вагу!"`
   - Інакше: `"Зацікавив цей товар? Можу допомогти з оформленням!"`
