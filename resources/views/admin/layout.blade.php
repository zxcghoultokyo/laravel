        ...
        <aside class="sidebar-transition fixed lg:relative z-50 h-full bg-white border-r border-gray-200 flex flex-col"
            ...
            <nav class="flex-1 overflow-y-auto p-3 space-y-1">
                ...
                <a href="{{ route('admin.triggers') }}" 
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.triggers') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}"
                   :class="{ 'justify-center': sidebarCollapsed }"
                   :title="sidebarCollapsed ? 'Тригери' : ''">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                    </svg>
                    <span x-show="!sidebarCollapsed" class="font-medium">Тригери</span>
                </a>
