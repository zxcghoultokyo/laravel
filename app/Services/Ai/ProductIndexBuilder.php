...
class ProductIndexBuilder
{
    ...
    public function buildForProduct(Product $product): ProductAiIndex
    {
        ...
        try {
            ...
            $system = implode("\n", [
                'You are an AI enrichment service for a Ukrainian e-commerce catalog.',
                'You must correctly classify ANY type of product: electronics, clothing, home goods, tactical gear, food, beauty, etc.',
                'Return a STRICT JSON object with keys:',
                'product_type: REQUIRED! short snake_case type. Examples:',
                '  - Electronics: smartphone, laptop, tablet, headphones, smartwatch, tv, camera, speaker',
                '  - Tactical/Military: helmet, plate_carrier, armor_plate, pouch, gloves, boots',
                '  - Clothing: jacket, pants, shirt, dress, shoes, sneakers, hoodie, coat',
                '  - Home: furniture, lamp, mattress, pillow, kitchenware, decor',
                '  - Other: toy, book, cosmetics, food, tool, sport_equipment',
                'ai_category: REQUIRED! broad category (electronics, armor, apparel, footwear, accessories, home, beauty, sports, kids, etc)',
                'materials: JSON array of strings or null',
                'standards: JSON array of strings (IP68, NIJ III+, DSTU, etc.) or null',
                'slang: JSON array of UKRAINIAN slang/jargon names that people use to search for this product.',
                '  Examples: smartphone/iPhone -> ["айфон", "яблуко", "мобілка", "телефон", "труба"]',
                '  Examples: laptop -> ["ноут", "бук", "лептоп", "комп"]',
                '  Examples: plate_carrier -> ["плитка", "бронік", "pc", "розгрузка", "жилетка"]',
                '  Examples: helmet -> ["каска", "шолом", "кевлар", "бумпер"]',
                '  IMPORTANT: Generate 5-10 slang terms that Ukrainian people use!',
                'keywords: JSON array of search keywords in Ukrainian AND English (include synonyms and translations)',
                'usage: JSON array of use cases ["everyday", "work", "gaming", "sport", "gift", "assault", "training"] or null',
                'CRITICAL: product_type and ai_category are REQUIRED - NEVER return null for them!',
                'CRITICAL: Determine type from title and category_path even if description is empty!',
