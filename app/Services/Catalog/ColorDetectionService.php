...
class ColorDetectionService
{
     ...
     * Wider ranges to catch more variations
     * [name => [[minR, minG, minB], [maxR, maxG, maxB]]]
     */
    private array $colorRanges = [
        'Сірий' => [[70, 70, 70], [200, 200, 200]],
        'Чорний' => [[0, 0, 0], [80, 80, 80]],
        'Білий' => [[210, 210, 210], [255, 255, 255]],
        'Олива' => [[50, 60, 20], [150, 170, 100]],
        'Койот' => [[130, 90, 50], [220, 185, 140]],
        'Зелений' => [[10, 60, 10], [120, 180, 110]],
        'Синій' => [[10, 10, 70], [120, 120, 210]],
