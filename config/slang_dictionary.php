...
return [
    ...
    // === МЕДИЦИНА ===
    'tourniquet' => [
        'slang' => ['турнікет', 'джгут', 'турник', 'кат', 'соф'],
        'synonyms' => ['кровоспинний джгут', 'турнікет', 'джгут кровоспинний'],
        'typos' => ['турнекет', 'турнікєт'],
        'en' => ['tourniquet', 'cat', 'sof-t', 'tq'],
    ],
    ...
    'headset' => [
        'slang' => ['гарнітура', 'навушники', 'активки', 'пелтори', 'комтаки', 'еармори'],
        'synonyms' => ['тактична гарнітура', 'активні навушники', 'шумоподавляючі навушники'],
        'typos' => ['гарнитура', 'навушнікі'],
        'en' => ['headset', 'comtac', 'peltor', 'earmor', 'active hearing protection'],
    ],
