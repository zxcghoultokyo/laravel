...
- PRODUCT_COMPARISON: порівняння товарів (яка краще, чим відрізняється, порівняй, що вибрати, яку обрати, краще з цих)
...
- Видали службові слова: 'допоможи', 'підібрати', 'мені', 'покажи', 'розкажи', 'про', 'знайди', 'потрібна', 'потрібен', 'хочу', 'шукаю'
- Залиш ТІЛЬКИ назву товару/категорії в називному відмінку (плитоноска, шолом, берці)
- Приклади: 'допоможи мені підібрати плитоноску' → 'плитоноска', 'покажи чорні берці 43' → 'чорні берці 43'

Для PRODUCT_COMPARISON: normalized_query залиш порожнім ''
