...
return [
    ...
    'starter_kit' => [
        'slang' => ['базовий набір', 'стартовий набір', 'набір новобранця', 'мінімальний набір'],
        'synonyms' => ['комплект піхотинця', 'базове спорядження', 'стартовий комплект'],
        'en' => ['starter kit', 'basic kit', 'beginner set'],
    ],
];
