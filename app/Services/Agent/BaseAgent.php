...
Якщо вже показав товари з категорії і більше немає:
...
Якщо search_products НЕ знайшов товарів по запиту (перший пошук, не "покажи ще"):
- НЕ викликай get_popular_products() — це показує нерелевантні товари!
