...
**Проблема:** ~~Дорого перезапускати enrichment~~ **ОПТИМІЗОВАНО!**

**Реалізоване рішення (v2025.01):**
Використовується `gpt-5-nano` для масового enrichment:

| Модель | Input/1M | Output/1M | Використання |
|--------|----------|-----------|--------------|
| gpt-5.2 | $1.75 | $14.00 | Основна модель (чат) |
| gpt-5.2-pro | $21.00 | $168.00 | Складні задачі |
| gpt-5-nano | $0.05 | $0.40 | **AI Enrichment** ✓ |
...
# Дешева модель для масового enrichment
OPENAI_MODEL_ANALYZE=gpt-5-nano
```

**Вартість enrichment ~2300 товарів:**
- gpt-5.2: ~$35
- gpt-5-nano: ~$1.15 (**30x дешевше!**)
