...
PROMPT;
    ...
    private function getFallbackSynonyms(): array
    {
        ...
        return [
            ...
            // === ТАКТИЧНЕ (fallback для тактичних магазинів) ===
            'плитоноски' => ['плитоноска', 'бронік', 'plate carrier', 'pc', 'бронежилет', 'жилет', 'носій плит', 'броник', 'плитник'],
            'шоломи' => ['шолом', 'каска', 'helmet', 'балістичний шолом', 'кевлар', 'шлем', 'helm', 'fast', 'mich'],
            'турнікети' => ['турнікет', 'cat', 'tq', 'джгут', 'кровоспин', 'tourniquet', 'жгут', 'кровоспинний'],
            'берці' => ['берці', 'берцы', 'boots', 'черевики', 'тактичні черевики', 'tactical boots', 'військові черевики'],
