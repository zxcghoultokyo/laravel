...
class CrossSellService
{
    ...
    protected array $fallbackRules = [
        'plate_carriers' => ['підсумки', 'балістичні плити'],
    ...
    protected function askAiForAccessories(Product $product): array
    {
        try {
            ...
            $prompt = sprintf(
                "Користувач купує тактичний товар категорії: %s\nНазва: %s\n\nВибери 2-3 категорії ДРІБНИХ АКСЕСУАРІВ або СУПУТНІХ ТОВАРІВ які б логічно доповнили цю покупку.\n\nВАЖЛИВО:\n- Вибирай тільки категорії дрібних речей чи аксесуарів, НЕ основний одяг (штани, куртки, шорти)\n- Для рукавичок доречно: балаклави, захисні окуляри, шапки\n- Для плитоносок: підсумки, панелі\n- Для взуття: шкарпетки, устілки\n- Обирай релевантні аксесуари з однієї сфери використання\n\nДоступні категорії:\n%s\n\nВідповідь у форматі JSON масиву з об'єктами: [{\"category\": \"назва категорії точно як у списку\", \"reason\": \"чому це корисно\"}]",
