<div>
    ...
    @if($conversionsActiveTab === 'cart')
        <div class="grid grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                @php
                    $conversionRate = count($cartEvents) > 0 
                        ? round(count($chatAttributedConversions) / count($cartEvents) * 100, 1) 
                        : 0;
                @endphp
                        ...
                        <div x-show="expanded" x-collapse class="px-4 pb-4 border-t border-gray-100 bg-gray-50">
                            ...
                            @if($checkout['session_id'])
                                <div class="mt-3 pt-3 border-t border-gray-200">
                                    <button wire:click="viewConversionSession('{{ $checkout['session_id'] }}')" 
