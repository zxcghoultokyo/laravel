    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <button wire:click="generateForStore" 
                    ...
                    class="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 disabled:opacity-50">
                <svg wire:loading.remove wire:target="generateForStore" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                </svg>
                <svg wire:loading wire:target="generateForStore" class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <span wire:loading.remove wire:target="generateForStore">🤖 Згенерувати для магазину</span>
                <span wire:loading wire:target="generateForStore">Генерую...</span>
            </button>
                    ...
                    <div class="border-t border-gray-200 pt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-xs text-gray-500 mb-1 flex items-center gap-1">
                                    Тип магазину
                                    <span class="text-gray-400 cursor-help" title="Тип магазину для підбору відповідного стилю спілкування та експертизи.">ⓘ</span>
                                </label>
