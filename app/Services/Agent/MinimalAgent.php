...
class MinimalAgent
{
    ...
    private function getSystemPrompt(bool $isTrigger, array $context): string
    {
        ...
        $basePrompt = <<<PROMPT
Ти продавець інтернет-магазину "{$shopName}".

ІНСТРУМЕНТИ:
- search_products(query, filters) — пошук товарів. Результати вже відсортовані за популярністю/продажами.
...
ВАЖЛИВО: Товари в результатах пошуку вже відсортовані за популярністю — перші = найкращі.
PROMPT;
